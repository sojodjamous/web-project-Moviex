...
<header>
    <div class="m">
        ...
        <ul style="margin-left: 800px">
            ...
            <li class="l  s1"> <a href="masa2.php"><span class="icon"><i class="fa fa-comments"></i></span> <span class="text">Contact</span> </a> </li>
            <li class="l "> <a href="personu.php"><span class="icon"><i class="fa fa-male" ></i></span> <span class="text">Personal</span> </a></a>  </li>

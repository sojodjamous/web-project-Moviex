    ...
    <header class="">
        <div class="navbar">
            ...
            <div class="navbar-actions">
                ...
                <a href="sm.php" class="navbar-signin">
                    <span>Back</span>
                    ...
                    while($row = mysqli_fetch_array( $res)):?>
                        <div class="mov" >
                            ...
                            <div class="side botin">
                                ...
                                <?php
                                $id=$row['Id'];
                                echo'<a href="mu.php?cartid='.$id.'"<i class="fa fa-film" style="margin-left: 5px"> </i></a>' ;
                                ?>

                                <?php
                                $id=$row['Id'];
                                echo   '<a href="d.php?deleteid=' . $id . ' "<i class="fa solid fa-trash-can"></i></a>' ;
                                ?>
                            </div>
                            <div class="side main">
                                <?php
...
<!--                <form method="post" action="index.php"></form>-->
                <div class="card-image">
                    <a href="horror.php" ><img style=" height: 250px; " src="horror.jpg"></a>
                </div>
                <div class="card-text">
                    <h2>Horror</h2>
                </div>
            ...
            <div class="card rgb">
                <div class="card-image">
                    <a href="actin.php"><img style="height: 250px;" src="action.jpg"></a>
                </div>
                <div class="card-text">
                    <h2>Action</h2>
                </div>
            ...
            <div class="card rgb">
                <div class="card-image">
                    <a href="cla.php"><img style="height: 250px;"  src="comedy.jpg"></a>
                </div>
                <div class="card-text">
                    <h2>Comedy</h2>
                </div>
            ...
            <div class="card rgb" >
                <div class="card-image">
                    <a href="ani.php"><img style="height: 250px;"  src="animated.jpg"></a>
                </div>
                <div class="card-text">
                    <h2>Animation</h2>
                </div>
